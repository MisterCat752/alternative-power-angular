...
| ----------------------------------------------------------- | ------------------------------------------------------------ |
| ![Home Page Screenshot](public/preview/home-screenshot.png) | ![Catalog Screenshot](public/preview/catalog-screenshot.png) |
...
| Cart                                                   |
| ------------------------------------------------------ |
| ![Cart Screenshot](public/preview/cart-screenshot.png) |
...
| Users Page                                               |
| -------------------------------------------------------- |
| ![Users Screenshot](public/preview/users-screenshot.png) |
...
| Product CRUD                                                           |
| ---------------------------------------------------------------------- |
| ![Product CRUD Screenshot](public/preview/product-crud-screenshot.png) |
...
| ---------------------------------------------------------------- | -------------------------------------------------------------------- |
| ![Inventory Screenshot](public/preview/inventory-screenshot.png) | ![Stock Moves Screenshot](public/preview/stock-moves-screenshot.png) |
...
| -------------------------------------------------------- | ---------------------------------------------------------- |
| ![Sales Screenshot](public/preview/sales-screenshot.png) | ![Offers Screenshot](public/preview/offers-screenshot.png) |
